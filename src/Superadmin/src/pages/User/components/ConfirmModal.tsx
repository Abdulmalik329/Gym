                    ...
                    {state.onConfirm ? (
                        <>
                            <button
                                ...
                                className={`w-full py-4 rounded-2xl font-black text-white transition-transform active:scale-95 ${isDanger ? 'bg-rose-600 hover:bg-rose-700' : 'bg-blue-600 hover:bg-blue-700'
                                    }`}
                            >
                                Tasdiqlash
                            </button>
